...
DOC
          ...
          _vars      => [ qw (template charset htmltitle graphborders colortext colorbackground colorborder defaultfont defaultfontsize titlefont titlefontsize axisfont axisfontsize unitfont unitfontsize legendfont legendfontsize watermarkfont watermarkfontsize) ],
          template   => 
         {
          _doc => <<DOC,
