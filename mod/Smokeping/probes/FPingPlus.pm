package Smokeping::probes::FPingPlus;

=head1 301 Moved Permanently

This is a Smokeping probe module. Please use the command 

C<smokeping -man Smokeping::probes::FPingPlus>

to view the documentation or the command

C<smokeping -makepod Smokeping::probes::FPingPlus>
...
sub pod_hash {
      return {
              name => <<DOC,
Smokeping::probes::FPingPlus - FPingPlus Probe for SmokePing
DOC
              description => <<DOC,
Integrates FPingPlus as a probe into smokeping. The variable B<binary> must 
